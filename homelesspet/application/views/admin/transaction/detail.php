			...
			<div class="panel-body" >
				...
				<div class="table-responsive" >
					<table class="table table-hover" >
						<thead>
							<tr class="info" >										
								<th class="text-center" style="background-color: rgb(144,129,241);color:white">STT</th>
								<th style="background-color: rgb(144,129,241);color:white">Tên sản phẩm</th>
								<th style="background-color: rgb(144,129,241);color:white">Số lượng</th>
								<th style="background-color: rgb(144,129,241);color:white">Giá</th>
								<?php if ($transaction->status=='0') { ?>
									<th style="background-color: rgb(144,129,241);color:white">Hành động</th>	<?php
								} ?>		
